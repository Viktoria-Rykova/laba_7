; ModuleID = 'complex_example.cpp'
source_filename = "complex_example.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_complex_example.cpp, i8* null }]
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  ...
  %2 = tail call double @cabs(double noundef 3.000000e+00, double noundef 4.000000e+00) #7
  %3 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertIdEERSoT_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef %2)
...
23:                                               ; preds = %16
  tail call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %13)
  ...
  %28 = tail call noundef signext i8 %27(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %13, i8 noundef signext 10)
  br label %29

29:                                               ; preds = %20, %23
  %30 = phi i8 [ %22, %20 ], [ %28, %23 ]
  %31 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %3, i8 noundef signext %30)
  %32 = tail call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %31)
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_complex_example.cpp() #6 section ".text.startup" {
